...
/**
 * The outcome of asking a provider which files a pull or merge request changed. An
 * unavailable list is never treated as empty: it means nothing could be checked.
 *
