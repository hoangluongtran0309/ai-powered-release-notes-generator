...
human review, and Draft Release slices: one Spring Boot
application, PostgreSQL/Flyway V1-V7, owner registration, session
...
settled changes, REST/UI paths, and Testcontainers tests.
